...
class ViewSave extends alfrid.View {
	...
	_init() {
		...
		let ux, uy;
		const {maxRadius, maxY, radius} = params.particles;
		let r = radius;
		...
		function getPos() {
			...
			return [random(-maxRadius, maxRadius), random(-r, r), random(-r, r)];
		}
		...
		this.mesh.bufferData(extras2, 'aExtra2', 3);
