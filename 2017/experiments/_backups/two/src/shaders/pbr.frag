...
void main() {
	...
	vec3 color 			= getPbr(N, V, uBaseColor, 1.0 -(uRoughness - invertMap), 1.0 - (uMetallic + invertMap * 0.75), 0.5);
	...
	// color 				= mix(uColor, color, colorMap);
	color 				= mix(color, uColor, uOutline);
